...
export class Rule extends Lint.Rules.AbstractRule {
    ...
    public static FAILURE_STRING: string = 'new line before class property declaration is missing';
...
class Walk extends Lint.RuleWalker {
    ...
    private getPrevLinesText(node: ts.PropertyDeclaration, sourceFile: ts.SourceFile, lineIndex: number = 1): string {
    ...
    private isNewLineBefore(node: ts.PropertyDeclaration, ): boolean {
